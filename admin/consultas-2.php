		...
		<section id="pagina-clientes" class="area-de-conteudo p-2 p-sm-3" style="box-shadow: none !important">
			<header id="cabecalho" class="mb-5 __mensagem-rececao">
				<div class="referencia">
					<h1 class="mb-0">Respostas do Quiz</h1>
			...
			<div class="table-responsive">
				<table id="tabela-consulta" class="table consultas">
					<thead class="position-sticky sticky-top bg-white">
						<th scope="col"></th>
						<th scope="col">Nome</th>
						<th scope="col text-center">Data de Realização</th>
						<th scope="col">CPF</th>
						<th scope="col text-center">Horário</th>
						<th scope="col">Título Quiz</th>
						<th scope="col"></th>
					</thead>
           ...
           -->
					...
					<tbody>
						<tr>
							...
							<td>Loren Ipsum</td>
							<td class="text-center">21/09/2022</td>
							<td>Lorem Ipsum</td>
							<td class="text-center">15H05</td>
							<td>Lorem Ipsum</td>
							<td><button class="_vizualizar btn btn-outline">Vizualizar</button></td>
						</tr>
