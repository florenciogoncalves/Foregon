...
<body id="quiz" class="landing-page">
	...
	<main id="quiz-form" class="row">
		<div class="container-fluid d-flex p-0 p-sm-3 col-12 col-sm-10 col-md-9 col-lg-8">
			<form class="interative-area form-group col-12 p-4 p-md-5 pb-md-4 my-auto">
				...
				<span class="subcategory-title mx-0 w-100">Lorem ipsum dolor sit amet, consectetur adipis cing elit
					consectetur adipis cing elit.</span>
				<fieldset class="row gap-3">
					<fieldset class="px-0 row gap-3">
						<input type="tel" class="form-control col-sm" placeholder="Lorem Ipsum" />
						<input type="tel" class="form-control col-sm" placeholder="Lorem Ipsum" />
					</fieldset>
				...
				<div class="row col-8 d-flex mt-3 justify-content-center mx-auto">
					<button type="submit" class="btn btn-primary mb-3 mt-3 d-flex justify-content-center">
						Prosseguir
					</button>
				</div>
