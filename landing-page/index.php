	...
	<body class="landing-page">
		...
		<div id="landing-pos-header" class="margem-topo row">
			<div class="container-fluid py-3 py-md-4">
				<form
					class="interative-area form-group col-12 col-sm-8 col-md-7 col-lg-6 px-4 px-sm-5 pt-3 my-auto">
					...
					<fieldset class="mt-3 mb-md-2">
						<input type="number" placeholder="CPF" class="campo form-control" />
					</fieldset>
		...
		<main id="conteudo-principal">
			<div
				id="algumas-informacoes"
				class="container-fluid accordion accordion-flush col-11 col-sm-10 col-lg-9 mt-5 mb-5 gap-2 row mx-auto">
				<!-- First item -->
				<div class="accordion-item">
					<h2 id="flush-headingOne" class="accordion-header">
						<button
							class="row accordion-button collapsed"
							type="button"
					...
					<div
						...
						class="texto-pequeno accordion-collapse collapse"
						aria-labelledby="flush-headingOne"
						data-bs-parent="#algumas-informacoes">
			...
			<div id="product-area" class="products container-fluid px-0 mb-5 pb-lg-0">
				...
				<span class="subcategory-title text-center"
					>Lorem ipsum dolor sit amet, consectetur adipis cing elit consectetur
					adipis cing elit.</span
				>

				<ul
					class="row gap-sm-3 gap-md-4 col-12 col-sm-12 col-md-10 col-lg-9 p-0 px-3 px-sm-2 mx-auto justify-content-between p-sm-5 p-lg-3 p-lg-0 py-sm-3">
					<!-- Item - Cartão produto -->
					<li class="card col-6 col-sm col-md rounded-1 row p-0">
						<figure
							class="p-0 pt-2 p-sm-2 pt-sm-3 px-sm-0 px-lg-3 pb-0 pb-sm-1 mb-3 mb-sm-2 mb-lg-3">
							<img
								src="./../image/product-area-img.svg"
								alt="Minha Bufunfa"
								class="card__image img-fluid w-50 mb-3" />
					...
					<li class="card col-6 col-sm col-md rounded-1 row p-0">
						<figure
							class="p-0 pt-2 p-sm-2 pt-sm-3 px-sm-0 px-lg-3 pb-0 pb-sm-1 mb-3 mb-sm-2">
							<img
								src="./../image/product-area-img.svg"
								alt="Minha Bufunfa"
								class="card__image img-fluid w-50 mb-3" />
		...
		<footer id="main-footer" class="container-fluid mt-5 p-3 p-sm-4 p-md-4 row">
			<div
				id="contate-nos"
				class="col-12 col-sm col-md-4 p-sm-4 pt-sm-3 pb-sm-3">
				<img
				...
				<div class="container-fluid p-0 d-none d-sm-flex">
					...
					<nav class="row p-0 gap-1 col-5 col-md-8">
						<a class="col-2" href="https://pt-br.facebook.com/" target="_blank" rel="noopener noreferrer"
							><img
								class="img-fluid h-50"
								src="./../image/redes-sociais/Facebook.svg"
								alt="Facebook"
						/></a>
						<a class="col-2" href="https://twitter.com/" target="_blank" rel="noopener noreferrer"
							><img
								class="img-fluid h-50"
								src="./../image/redes-sociais/Twitter.svg"
								alt="Twitter"
						/></a>
						<a class="col-2" href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer"
							><img
								class="img-fluid h-50"
								src="./../image/redes-sociais/Instagram.svg"
								alt="Instagram"
						/></a>
						<a class="col-2" href="https://pt.linkedin.com/" target="_blank" rel="noopener noreferrer"
							><img
								class="img-fluid h-50"
								src="./../image/redes-sociais/LinkedIn.svg"
								alt="Linkedin"
						/></a>
						<a class="col-2" href="https://www.youtube.com/" target="_blank" rel="noopener noreferrer"
							><img
								class="img-fluid h-50"
								src="./../image/redes-sociais/YouTube.svg"
								alt="Youtube"
						/></a>
					</nav>
				</div>
			...
			<div
				class="footer-links row gap-1 col-12 col-md p-3 pb-sm-2 pt-sm-2 justify-content-between m-0 m-sm-2 mb-0 mt-sm-0 mh-100">
			...
			<span class="_mkti-brand"
				>Minhabufanfa - © 2022 All Rights Reserved Feito com ♥ pela MKTI</span
			>
		</footer>
