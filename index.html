	...
	<body class="container-fluid">
		...
		<main
			...
			<div class="user-ratings container-fluid col-lg-11 col-12 mt-4 mb-4 ml-0">
				...
				<ul
					class="row p-0 gap-3 col-11 col-md-10 px-md-4 col-lg-10 justify-content-center m-auto">
					<!-- Item Cartão usuário -->
					<li class="card col-10 col-sm p-2 p-md-3">
						<figure class="col col-lg-10 m-auto">
							<img
								src="./arquivos-temporarios/Ellipse 142.svg"
								alt="magem-de-perfil"
								class="card__image rounded-circle img-fluid d-flex m-auto mb-3" />
							<figcaption>
					...
					<li class="card col-10 col-sm p-2 px-lg-3 p-md-3">
						<figure class="col col-lg-10 m-auto">
							<img
								src="./arquivos-temporarios/Ellipse 142.svg"
								alt="magem-de-perfil"
								class="rounded-circle img-fluid d-flex m-auto mb-3" />
							<figcaption>
								<h4 class="card__title mb-2">Luiza lipsum Dollor</h4>
								<p class="card__description">
									It is a long established fact that a reader will be distracted
		...
		<footer id="main-footer" class="container-fluid mt-5 p-3 p-sm-4 p-md-4 row">
			<div
				...
				<div class="container-fluid p-0 d-none d-sm-flex flex-column">
					<span class="col-5 col-md-8 text-center mt-2 mt-lg-0"
						>Acesse nossas redes</span
					>
