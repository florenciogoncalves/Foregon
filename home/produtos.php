...
<html lang="pt-BR">
	<head>
		...
		<link rel="stylesheet" href="./../style/responsive.css" /></head
	>html
		...
		<main id="conteudo-principal" class="col p-3 p-sm-4 pb-5 mb-3 mb-lg-0">
			<div class="container-fluid">
				<section id="product-area" class="product-area p-2 p-sm-3">
					<h3 class="titulo">Nossos produtos <a href="">Ver todos</a></h3>

					<div class="products container-fluid pb-3 px-0 mt-4 col-lg-11">
						<ul
							class="row gap-3 gap-sm-2 gap-md-3 col-12 justify-content-center row-cols-3">
							<!-- Item - Cartão produto -->
							<li class="card purchased-product col-10 col-sm rounded-1 row">
								<figure class="p-0 pt-3 px-sm-0 px-lg-3 pb-1">
									<img
										src="./../image/card-mcx.svg"
										alt="Minha Bufunfa"
										class="card__image img-fluid w-50" />
