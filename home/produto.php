	...
	<main id="conteudo-principal" class="col p-3 p-sm-4 pb-5 mb-3 mb-lg-0">
		<div class="container-fluid pb-5">
			...
			?>
				...
				<div id="card-produto" class="area-de-conteudo p-2">
					<figure class="p-0 pt-3 px-sm-0 px-lg-3 pb-1 row">
						<img src="./../_storage/produtos/<?= $produto->foto_produto; ?>" alt="Minha Bufunfa" class="card__image img-fluid col-6 p-0" />
			...
			<div class="container-informacoes area-de-conteudo row p-3 mt-2 gap-4">
				...
				<span class="texto-coluna p-0 col-auto __elemento-pontos">Acumule 4<br />pontos a cada<br />dólar gasto</span>
				...
				<a href="" class="titulo-artigo _texto--verde p-0 col col-md-auto container-informacoes__descubra">Descubra suas chances de<br />aprovação neste cartão
					...
					<thead>
						<tr>
							<th class="tabela-coparacao-cartoes__cabecalho pe-4" scope="col">
								...
								<span class="__subtitulo texto-coluna">It is a long established fact that a reader will be
							...
							<th class="tabela-coparacao-cartoes__cartao" scope="col">
								<div class="container-card px-3">
									<img class="card__image __imagem-card mb-1" src="./../image/card-mcx.svg" alt="Imagem do cartão" />
									<span class="__nome-card">Lorem Ipsum</span><button class="__botao-solicitar-card mt-3 mb-1">
										solicitar cartão
									</button>
								</div>
							</th>
		...
		<div id="landing-pos-header" class="container-todas-informacoes-produto margem-topo row">
			<div class="interative-area form-group col-12 col-sm-8 col-md-7 col-lg-6 px-0 px-lg-4 px-sm-5 pt-3 my-auto w-100">
