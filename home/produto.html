...
<html lang="pt-BR">
	...
	<body
		class="home-page padrao_produtos container-fluid d-flex d-lg-grid _fullscreen-main">
			...
			<ul
				...
				<li class="col px-0 py-2 rounded-3" id="vizualizando">
					<a href="./produtos.html"
						><img
							class="img-fluid m-auto d-flex"
							src="./../image/icones-do-menu/produtos-white.svg"
							alt="products"
					/></a>
				</li>
				<li class="col px-0 py-2 rounded-3">
		...
		<main id="conteudo-principal" class="col p-3 p-sm-4 pb-5 mb-3 mb-lg-0">
			<div class="container-fluid pb-5">
				...
				<div id="card-produto" class="area-de-conteudo p-2">
					<figure class="p-0 pt-3 px-sm-0 px-lg-3 pb-1 row">
						<img
							src="./../image/produto-bg-img.png"
							alt="Minha Bufunfa"
							class="card__image img-fluid col-6 p-0" />
						<figcaption class="container col-6">
							<h4>Cartão Pro lipsum<span class="visa">(Visa)</span></h4>
							...
							<h6 class="valor">R$ <span class="monetize">100</span></h6>
				...
				<div class="container-informacoes area-de-conteudo row p-3 mt-2 gap-4">
					...
					<span class="texto-coluna p-0 col-auto __elemento-pontos"
						>Acumule 4<br />pontos a cada<br />dólar gasto</span
					>
					...
					<a
						href=""
						class="titulo-artigo _texto--verde p-0 col col-md-auto container-informacoes__descubra"
						>Descubra suas chances de<br />aprovação neste cartão
						<img src="./../image/proceder.svg" alt=""
					/></a>
				</div>
				...
				<div class="container-tabela-comparacao table-responsive">
					<table class="table tabela-comparacao-cartoes mt-5">
						...
						<thead>
							<tr>
								<th
									class="tabela-coparacao-cartoes__cabecalho pe-4"
									scope="col">
									<h2 class="__titulo _texto--verde">Comparação de cartões</h2>
									<span class="__subtitulo texto-coluna"
								...
								<th class="tabela-coparacao-cartoes__cartao" scope="col">
									<div class="container-card px-3">
										<img
											class="card__image __imagem-card mb-1"
											src="./../image/card-mcx.svg"
											alt="Imagem do cartão" />
										<span class="__nome-card">Lorem Ipsum</span
										><button class="__botao-solicitar-card mt-3 mb-1">
											solicitar cartão
										</button>
									</div>
								</th>
				...
				<div>
					<button
						class="__botao-solicitar-card __ver-analise-completa mt-3 mb-1 mx-auto row">
			...
			<div
				id="landing-pos-header"
				class="container-todas-informacoes-produto margem-topo row">
					<div
						...
						<div class="container-diferencas">
							<div class="contexto texto-coluna">
								<span class="contexto__informacao _contexto--esquerda"
									>Lorem Ipsum</span
								>
								<span class="contexto__informacao _contexto--direita"
									>Lorem Ipsum</span
								>
							</div>
							<div class="contexto texto-coluna">
