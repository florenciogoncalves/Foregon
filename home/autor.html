...
<html lang="pt-BR">
	...
	<body id="artigo-page" class="home-page container-fluid d-flex d-lg-grid">
		...
		<main
			...
			class="col p-3 p-sm-4 pb-5 mb-3 mb-lg-0 container-fluid">
			<div class="row">
				<section
					id="leia-artigo"
					class="area-de-conteudo autor-artigo col-12 col-lg-9 p-0">
					<figure>
						<img
							class="img-fluid"
				...
				<section
					id="graficos-usuario"
					class="row col-12 col-lg-9 p-0 gap-2 gap-sm-3 mb-3 mt-5">
					<div id="ultimos-artigos" class="col p-0">
						...
						<div class="container row gap-3 p-0">
							<figure class="artigo-usuario col col-lg mb-2 my-3">
								<img
									class="img-fluid m-auto d-flex"
									src="./../arquivos-temporarios/artigo-img.png"
									alt="Imagem" />
								<figcaption>
